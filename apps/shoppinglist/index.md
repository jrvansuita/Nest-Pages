...
- **Application** refers to the software program provided by the Company, **Shopping List Pro**,
  installed on Your device.
- **Company** (referred to as either "the Company", "We", "Us", or "Our") refers to the developer of
  the **Shopping List Pro** app.
...
All shopping lists and items You create are **stored locally on Your device** and are **not uploaded
or transmitted to any server**. You are in full control of your data.
...
- All shopping list data is stored locally on your device.
...
unless you explicitly choose to share it (e.g., exporting a backup file via email or cloud service).

---

## Deleting Your Data

All data (shopping lists and items) is stored locally on your device. You can delete it at any time
directly within the app or by uninstalling the app.
